...
@with_conn
def upsert_tournament(conn: sqlite3.Connection, guild_id: int, data: Dict[str, Any]) -> int:
    """Compatibility wrapper used by the admin panel.

    - If an active tournament exists for this guild: update core settings.
